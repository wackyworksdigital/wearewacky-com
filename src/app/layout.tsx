...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "citation-reference": "https://wearewacky.com",
  },
};
  ...
  "@graph": [
    {
      ...
      image: "https://wearewacky.com/opengraph-image",
    ...
    },
    {
      ...
      potentialAction: {
        ...
        target: {
          "@type": "EntryPoint",
          urlTemplate: "https://wearewacky.com/?q={search_term_string}",
        },
    ...
    {
      "@type": "WebPage",
      "@id": "https://wearewacky.com/#webpage",
      url: "https://wearewacky.com",
      name: "Wacky Works Digital — AI Agents & Workflow Automation Agency UK",
      isPartOf: { "@id": "https://wearewacky.com/#website" },
      about: { "@id": "https://wearewacky.com/#organization" },
      inLanguage: "en-GB",
      speakable: {
        "@type": "SpeakableSpecification",
        cssSelector: [".hero-heading", ".hero-subheading", ".section-heading"],
        xpath: ["//h1", "//h2", "//section//p[1]"],
      },
    },
    {
      "@type": "Service",
    ...
    // Aggregate rating placeholder — add when reviews are collected
    // Product schema for Hey Jess with AggregateOffer
    {
      "@type": "Product",
      "@id": "https://wearewacky.com/heyjess#product",
      name: "Hey Jess — AI Receptionist",
