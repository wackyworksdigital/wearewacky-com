...
export const metadata: Metadata = {
  ...
  description: "Services page placeholder.",
};
    ...
    <main className="relative min-h-screen bg-[#f5ebe0] text-[#3d3428]">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center space-y-4">
          <p className="text-sm uppercase tracking-[0.3em] text-[#b07c4f]">services</p>
          <h1 className="text-4xl md:text-6xl font-black" style={{ fontFamily: "var(--font-space), Impact, sans-serif" }}>
            Coming soon
          </h1>
          <p className="text-lg opacity-70">We’re designing something special here.</p>
        </div>
      </div>
    </main>
  );
