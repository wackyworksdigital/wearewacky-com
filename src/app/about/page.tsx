              ...
              <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6">
                ...
                <div className="flex flex-col items-center group">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-white border border-gray-200 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-md p-3">
                    <Image src="/images/logos/google.svg" alt="Google" width={40} height={40} />
                  </div>
                ...
                <div className="flex flex-col items-center group">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-white border border-gray-200 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-md p-3">
                    <Image src="/images/logos/gemini.svg" alt="Gemini" width={40} height={40} />
                  </div>
                ...
                <div className="flex flex-col items-center group">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-white border border-gray-200 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-md p-3">
                    <Image src="/images/logos/cursor.svg" alt="Cursor" width={40} height={40} />
                  </div>
